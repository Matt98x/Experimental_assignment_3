...
def main():
    ...
    while not rospy.is_shutdown():
        ...
        if state_ == 0:
            ...
            elif regions_['front'] < 0.2 or regions_['fright'] < 0.2 or regions_['fleft'] < 0.2:
                change_state(1)
            ...
            if(err_pos < 0.3):
                change_state(2)
            if regions_['front'] > 1 and regions_['fright'] > 0.5 or regions_['fleft'] > 0.5 and math.fabs(err_yaw) < 0.05:
                change_state(0)
